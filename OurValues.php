...
<body>
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">About Us</a>
                        <div class="dropdown-menu"><a class="dropdown-item" href="admission.php">Admission</a><a class="dropdown-item" href="http://localhost/gbenga/OurStaff.php">Our Staffs</a><a class="dropdown-item" href="http://localhost/gbenga/OurValues.php">Our Values</a></div>
                    </li>
    ...
    <ol class="breadcrumb">
        <li class="home"><a href="http://localhost/gbenga/index.php"><i class="fas fa-home"></i><span>Home</span></a></li>
        <li><a href="#">About Us</a></li>
        <li class="active"><a href="#">Our Values</a></li>
    </ol>
    <div class="container-fluid">
        <div class="row flex-column flex-sm-row wrapper min-vh-100">
            <div class="col-12 col-sm-11 col-md-9 bg-light py-3">
                <h1>Our Values</h1>
                <p><br><br> <br> <br> <br> Achieving excellence is a great height that comes with being <br>determined and doing what’s right. Having the right values is a road map<br> to attaining that height. In GIS, we encourage every child to imbibe<br> those values that will lead to excellence; values like:<br><br><strong>*Perseverance</strong><br><strong>*Discipline</strong><br><strong>*Dialogue</strong><br><strong>*Responsibility</strong><br><strong>*Excellence</strong><br><strong>*Integrity</strong><br><strong>*Faith</strong><br><br><br> <br> <br><br> <br><br> <br><br></p>
            </div>
            <div class="col-12 col-sm-1 col-md-3 flex-shrink-1 p-0 bg-dark">
                <nav class="navbar navbar-dark navbar-expand-sm bg-dark text-nowrap flex-row align-items-start flex-sm-column">
                    <div class="container flex-sm-column"><a class="navbar-brand" href="#">
                            <h1>About Us</h1>
                        ...
                        <div class="collapse navbar-collapse" id="navcol-1">
                            <ul class="navbar-nav flex-column justify-content-between w-100">
                                <li class="nav-item" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Overview"><a class="nav-link" href="admission.php"><span class="d-inline-block d-sm-none d-md-inline-block">Admission</span></a></li>
                                <li class="nav-item" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Properties"><a class="nav-link" href="OurStaff.php"><span class="d-inline-block d-sm-none d-md-inline-block">Our Staff</span></a></li>
                                <li class="nav-item" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="right" title="Contacts"><a class="nav-link" href="OurValues.php"><span class="d-inline-block d-sm-none d-md-inline-block">Our Values</span></a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
